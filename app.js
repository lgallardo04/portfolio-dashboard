...
const translations = {
    es: {
        sidebar_title: "Analista de Sistemas / Full-Stack",
        ...
        card_title: "Analista de Sistemas & Full-Stack Developer",
        info_age: "Edad",
        info_years: "Años",
        info_id: "Cédula",
        ...
        bio_p1: "Analista de Sistemas (culminando el 6to semestre en fase final de pasantías ocupacionales en el IUTEPI para la obtención del título de T.S.U.) y Desarrollador Full-Stack con sólida experiencia práctica en la arquitectura, desarrollo e implantación de soluciones modernas (Next.js, React, TypeScript, Python FastAPI, PostgreSQL y Supabase).",
        ...
        stat_degrees: "En Pasantías (IUTEPI)",
        ...
        edu_iutepi_inst: "Instituto Universitario de Tecnología Para la Informática (IUTEPI) - Acarigua",
        edu_iutepi_title: "T.S.U. Análisis de Sistemas",
        edu_iutepi_badge: "En Pasantías — 6to Semestre (Por Graduarse)",
        edu_iutepi_desc: "Carrera de 6 semestres en total. Actualmente en fase final de pasantías ocupacionales culminando el 6to semestre a punto de graduarme para la obtención del título de T.S.U. Especialización en levantamiento y análisis de requerimientos, diseño de algoritmos, modelado de bases de datos relacionales, metodologías ágiles (Scrum) y programación full-stack.",
        edu_iutepi_date: "2024 - Presente (Fase Final: Pasantías)",
        edu_upt_inst: "Universidad Politécnica Territorial de Portuguesa \"J.J. Montilla\" (UPTP)",
        edu_upt_title: "P.N.F. Ingeniería Informática",
        edu_upt_badge: "3 Semestres Cursados (Estudios No Concluidos)",
        edu_upt_desc: "Estudios universitarios cursados y aprobados hasta el 3er semestre (carrera no concluida / retiro voluntario para dedicación técnica). Formación inicial en matemática discreta, lógica computacional, algoritmos, arquitectura de computadores, redes y proyectos sociotecnológicos comunitarios.",
        edu_upt_date: "2020 - 2022 (3 Semestres Aprobados)",
    ...
    en: {
        sidebar_title: "Systems Analyst / Full-Stack",
        ...
        card_title: "Systems Analyst & Full-Stack Developer",
        info_age: "Age",
        info_years: "Years",
        info_id: "ID Number",
        ...
        bio_p1: "Systems Analyst (currently in the final professional internship phase at IUTEPI, finishing the 6th semester to earn the Associate Degree in Systems Analysis) and Full-Stack Developer with hands-on experience in architecting, developing, and deploying modern web, mobile, and enterprise platforms (Next.js, React, TypeScript, Python FastAPI, PostgreSQL, and Supabase).",
        ...
        stat_degrees: "In Internships (IUTEPI)",
        stat_responsive: "Mobile-First & PWA",
        ...
        edu_iutepi_badge: "In Internships — 6th Semester (Near Graduation)",
        edu_iutepi_desc: "6-semester academic degree program. Currently completing the 6th and final semester in professional internships, on the verge of graduating with an Associate Degree in Systems Analysis. Rigorous training in software requirements elicitation, algorithm design, relational database architecture, Agile (Scrum), and full-stack OOP software development.",
        edu_iutepi_date: "2024 - Present (Final Phase: Internships)",
        edu_upt_inst: "UPT Portuguesa University \"J.J. Montilla\" (UPTP)",
        edu_upt_title: "B.S. in Informatics Engineering",
        edu_upt_badge: "3 Semesters Completed (Discontinued)",
        edu_upt_desc: "University coursework completed and passed up to the 3rd semester (studies not completed / voluntary withdrawal to focus on practical systems analysis and software development). Solid foundations acquired in discrete mathematics, computational logic, data structures, network fundamentals, and community sociotechnological systems.",
        edu_upt_date: "2020 - 2022 (3 Semesters Completed)",
